char *PIDName[]   ={"Constant  P", "Constant  I", "Constant  D", "Windowset  ", "Use in Boil", "Calibration"};
char *stageName[] ={"Mash In   ", "Stage1    ", "Stage2    ", "Stage3    ", "Stage4    ", "Stage5    ", "Stage6    ", "Mash Out  ", "Boil      "};
